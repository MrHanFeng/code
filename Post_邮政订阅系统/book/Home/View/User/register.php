...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
         <meta name="Generator" content="乐乐购物" />
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
        <meta name="Keywords" content="乐乐购物" />
        <meta name="Keywords" content="lelego" />
        <meta name="Keywords" content="乐乐购物 - Design by asturelizhe" />
        <meta name="Keywords" content="乐乐go" />
        <meta name="Keywords" content="乐乐购物" />
        <meta name="Description" content="乐乐购物" />
        <meta name="Description" content="lelego" />
        <meta name="Description" content="乐乐go" />
        <meta name="Description" content="lele购物" />
        <title>乐乐购物 - Design by asturelizhe</title>
    ...
    <body class="index_body">
        <div class="block clearfix" style="position: relative; height: 98px;">
            <a href="#" name="top"><img class="logo" src="{$smarty.const.IMG_URL}logo.jpg"></a>
                        ...
                        <form id="yw0" action="{$smarty.const.__SELF__}" method="post">                <table cellpadding="5" cellspacing="3" style="text-align:left; width:100%; border:0;">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input class="inputBg" size="25" name="password" id="User_password" type="password" value="" /> <span style="color:red;">
                                             {$user.password}
                                            </span>      
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td align="right"><label for="User_user_hobby">爱好
                                        </label></td>
            ...
            <div class="box_1">
                <div class="links clearfix"> 
                    ...
                    <a href="#" target="_blank" title="YONGDA 网上商店管理系统">
                        <img src="{$smarty.const.IMG_URL}yongda_logo.jpg" alt="YONGDA 网上商店管理系统" border="0" />
                    </a>
        ...
        <div id="footer">
            <div class="text">
                ©2015 design by asturelizhe 晋ICP备15001779号<br />
            </div>
        </div>
