...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        <div class="block clearfix" style="position: relative; height: 98px;">
            <a href="#" name="top">
                <img class="logo" src="{$smarty.const.IMG_URL}logo.jpg">
            </a>
                        ...
                        <table align="left" border="0" cellpadding="3" cellspacing="5" width="100%">
                            <tbody>
                                <tr>
                                    ...
                                    <td width="85%"><input name="username" size="15" class="inputBg" type="text" /></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input class="inputBg" size="15"
                                         name="captcha" type="text">
                                         <span>{$error_verify}</span>
            ...
            <div id="bottomNav" class="box block">
                <div class="box_1">
                    <div class="links clearfix"> 
                        <a href="#" target="_blank" title="YONGDA商城"><img src="{$smarty.const.IMG_URL}logo.jpg" alt="YONGDA商城" border="0"></a>
