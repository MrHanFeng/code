...
class Pager {    
    private $pageSize = 10;    
    private $pageIndex;    //当前页码为第几页
    private $totalNum;    //数据的总数量
    private $totalPagesCount;    //分页的页码数量
    private $pageUrl;           //每页的URL
    private static $_instance;    

    public function __construct($p_totalNum, $p_pageIndex, $p_pageSize = 10/*(先注释掉),$p_initNum=3,$p_initMaxNum=5*/) {    
